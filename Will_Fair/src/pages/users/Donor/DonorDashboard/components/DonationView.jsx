...
const DonationView = () => {
  ...
  const getProgressPercentage = () => {
    ...
    return Math.min(Math.round((donation.quantity_received / donation.quantity_needed) * 100), 100);
  };
        ...
        <div className="donation-image-container">
          ...
          <div className="donation-overlay">
            <div className="donation-category">
              ...
              <span className="category-text">{donation.category || 'General'}</span>
            </div>
            <div className="donation-status" style={{ backgroundColor: getStatusColor(donation.status) }}>
          ...
          <div className="donation-header">
            ...
            <div className="donation-urgency">
              {daysRemaining !== null && daysRemaining >= 0 && (
                <div className={`urgency-badge ${daysRemaining <= 7 ? 'urgent' : daysRemaining <= 30 ? 'moderate' : 'normal'}`}>
          ...
          <div className="progress-section">
            ...
            <div className="progress-stats">
              <div className="stat-item">
                <div className="stat-value">Rs. {(donation.quantity_received || 0).toLocaleString()}</div>
                <div className="stat-label">Raised</div>
              </div>
              <div className="stat-item">
                <div className="stat-value">Rs. {(donation.quantity_needed || 0).toLocaleString()}</div>
          ...
          <div className="campaign-details">
            <div className="detail-item">
              ...
              <div className="detail-content">
                ...
                <div className="detail-value">
                  {donation.due_date ? new Date(donation.due_date).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                  }) : 'No deadline set'}
            ...
            <div className="detail-item">
              ...
              <div className="detail-content">
                ...
                <div className="detail-value">{donation.category || 'General'}</div>
              </div>
            </div>
