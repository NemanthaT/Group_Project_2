...
const createEventController = async (req, res) => {
    ...
    try {
        ...
        // Update event with final image path
        const updateResult = await eventModel.updateEventImage(eventId, finalImagePath);
        ...
        const docsResult = await eventModel.addDocuments(eventId, documentData);
